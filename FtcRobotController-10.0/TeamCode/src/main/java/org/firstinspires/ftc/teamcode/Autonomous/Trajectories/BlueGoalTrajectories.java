...
public class BlueGoalTrajectories implements GoalTrajectories {
    ...
    private final Pose2d startPose = new Pose2d(60, 55,Math.toRadians(54));
    private final Pose2d shootPose = new Pose2d(25, 22, Math.toRadians(45));
    ...
    private void fillVariables() {
        ...
        goToTakeSecondBalls = drive.trajectorySequenceBuilder(moveToShootFirst.end(), 100)
                .lineToLinearHeading(new Pose2d(18, 20, Math.toRadians(90)))
                .build();
