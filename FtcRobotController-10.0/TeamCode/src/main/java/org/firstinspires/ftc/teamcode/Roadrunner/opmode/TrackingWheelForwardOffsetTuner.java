...
/**
 * This routine determines the effective forwardStart offset for the lateral tracking wheel.
 ...
 * the center of rotation with an arc length of change in y and a radius equal to the forwardStart
 ...
 * average of all the calculated forwardStart offsets derived from the calculation. This calculated
 * forwardStart offset is then added onto the current forwardStart offset to produce an overall estimate
 * for the forwardStart offset. You can run this procedure as many times as necessary until a
...
public class TrackingWheelForwardOffsetTuner extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        telemetry.addLine("Press play to begin the forwardStart offset tuner");
        ...
        telemetry.addLine(Misc.formatInvariant("Effective forwardStart offset = %.2f (SE = %.3f)",
