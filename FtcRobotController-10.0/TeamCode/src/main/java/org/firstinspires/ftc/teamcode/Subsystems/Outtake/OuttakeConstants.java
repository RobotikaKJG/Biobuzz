...
public class OuttakeConstants {
    ...
    public static final double outtakeServoMaxPosFar = 0.344;
    public static final double outtakeServoMaxPosClose = 0.36; //0.356;
    public static final double outtakeServoMinPos = 0.342; //0.344;
