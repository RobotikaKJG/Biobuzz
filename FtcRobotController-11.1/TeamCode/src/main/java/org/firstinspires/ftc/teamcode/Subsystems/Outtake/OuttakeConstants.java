...
public class OuttakeConstants {
    public static double turretServo1Min = 0.0;
    public static double turretServo2Min = 0.0;
    public static double turretServo3Min = 0.0;

    public static double turretServo1Max = 1.0;
    public static double turretServo2Max = 0.998;
    public static double turretServo3Max = 1.0;
